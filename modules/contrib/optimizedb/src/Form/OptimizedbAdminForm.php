...
class OptimizedbAdminForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['optimize_table']['optimization_period'] = [
      ...
      '#description' => $this->t('Last run: @date ago.', [
    ...
    $form['optimize_table']['tables'] = [
      ...
      '#markup' => $this->t('The size of all tables in the database: <b>@size</b>. View the size of the tables separately, you can on the page - <a href="@url">List of tables in the database</a>.', [
        '@size' => $size_tables,
