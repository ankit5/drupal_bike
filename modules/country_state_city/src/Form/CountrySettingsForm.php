...
/**
 * Country SettingsForm for importing country data.
 */
class CountrySettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['import'] = [
      '#title' => $this->t('Country data'),
      '#type' => 'submit',
      '#value' => $this->t('Import'),
      '#description' => $this->t('Import country data.'),
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $batch = [
      ...
      'operations' => [
        ['Drupal\country_state_city\Form\CountrySettingsForm::importCountry', []],
      ],
  ...
  public static function importCountry(array &$context) {
    ...
    $countries = json_decode(file_get_contents($module_path . '/data/countries.json'));
