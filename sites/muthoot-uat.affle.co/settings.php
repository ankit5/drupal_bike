<?php
// Using Secrets Manager Client
error_reporting(E_ALL);
ini_set('display_errors', TRUE);
ini_set('display_startup_errors', TRUE);

define("AWS_Key", "AKIAW2ZBEV7BG73JRWJN");
define("AWS_Secret", "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");
define("AWS_region", "ap-south-1");
define("api_url", "https://muthoot-uat.affle.co/api/v1/");
define("api_Authorization", "bW90b2thYXJ0Om1vdG9rYWFydDEyMyMj");
define("feed_vizury_retailer_id", '618cad5ab82d5c7dbc1df342');
define("website_url", "https://muthoot-uat.affle.co/frontend/");
...
// Connecttion for CMS Database
$databases['default']['default'] = array (
  'database' => $aws_db['cms_dbname'],
...
//Setting of S3 Bucket
$config['s3fs.settings']['bucket'] = $aws_secret_keys['s3_bucket_name'];
$config['s3fs.settings']['region']= AWS_region;
$settings['s3fs.access_key'] = AWS_Key;
$settings['s3fs.secret_key'] = AWS_Secret;
$settings['s3fs.use_s3_for_public'] = TRUE;
$settings['s3fs.use_s3_for_private'] = TRUE;

//Setting for mail SMTP
$config['smtp.settings']['smtp_on'] = "true";
$config['smtp.settings']['smtp_host'] = $aws_secret_keys['mail_smtp_host'];
$config['smtp.settings']['smtp_port'] = $aws_secret_keys['mail_smtp_port'];
$config['smtp.settings']['smtp_protocol'] = $aws_secret_keys['mail_smtp_protocol'];
$config['smtp.settings']['smtp_username'] = $aws_secret_keys['mail_smtp_username'];
$config['smtp.settings']['smtp_password'] = $aws_secret_keys['mail_smtp_password'];
...
$settings['config_sync_directory'] = 'sites/default/files/config_HQzUR1bgS0j9ZK8pzMDaQK5xYfz_egY7tH-REYWK5TRpRpIWRkeu2fljP-vjY_X4ehhGMeL_Gw/sync';
 ...
 * @endcode
 */
$settings['hash_salt'] = 'DYSKOkzoF2XNaLDlKEHSIEBItRTX8TeYZGQeW9dXr_FTJ6E7zuv6pz4JyHCIOdvpIIjRpreUCQ';
